      ...
      <div className="flex flex-col min-h-[420px]">
        ...
        {loading ? (
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            {/* TRAINING SPLIT */}
            <div>
              <label className="block text-xs text-slate-300 mb-1">Training split</label>
            ...
            {/* GENDER */}
            <div>
              <label className="block text-xs text-slate-300 mb-1">Gender (optional)</label>
              <div className="flex gap-2">
                {["MALE", "FEMALE"].map((g) => (
                  <button
                    ...
                    disabled={loading}
                    onClick={() => setGender(g)}
                    className={`flex-1 text-xs py-2 rounded-xl border transition disabled:opacity-60 ${
                      gender === g
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                <label className="block text-xs text-slate-300 mb-1">Age (optional)</label>
                <input
                  type="number"
                  min="10"
                  max="100"
              ...
              <div>
                <label className="block text-xs text-slate-300 mb-1">Height (cm, optional)</label>
                <input
                  type="number"
                  min="120"
                  max="230"
